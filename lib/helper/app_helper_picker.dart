...
class Picker {
  ...
  static void DatePicker({required BuildContext context, DateTime? initialDate, DateTime? firstDate, DateTime? lastDate, required Function(DateTime?)? onChanged}) async {
    ...
    CustomDatePickerDialog.show(context, initialDate: initial, firstDate: first, lastDate: last, onChanged: onChanged);
